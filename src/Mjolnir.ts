...
export interface ILogProxy {
    logMessage(level: LogLevel, module: string, message: string | any, additionalRoomIds?: string[] | string | null, isRecursive?: boolean);
}
...
export class Mjolnir implements ILogProxy {
    ...
    public async logMessage(level: LogLevel, module: string, message: string | any, additionalRoomIds: string[] | string | null = null, isRecursive = false) {
